    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600 mb-4">
          Access a shell inside your running container to debug, inspect files, or run commands.
        </p>
      </div>
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-4">
          ...
          {!sessionActive && terminalOutput.length === 0 && (
            <div className="bg-gray-50 p-8 rounded-lg text-center">
              ...
              <p className="text-gray-500">Click "Start Shell Session" to connect to your container.</p>
            </div>
          )}
        </div>
      )}
      ...
      {!execStatus?.available && (
        <div className="bg-gray-50 p-8 rounded-lg text-center">
          ...
          <p className="text-sm text-gray-400">
            Your application needs to have running containers to access the shell.
          </p>
        </div>
      )}
    </div>
