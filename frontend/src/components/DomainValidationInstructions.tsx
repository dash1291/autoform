...
export default function DomainValidationInstructions({
  ...
  const getDnsProviderInstructions = () => {
    const providers = [
      ...
      {
        name: "Namecheap",
        url: "https://www.namecheap.com/domains/domaincontrolpanel",
      },
    ...
    <div className="space-y-6">
      {certificateStatus === "PENDING_VALIDATION" && (
        <Alert>
          ...
          <AlertDescription>
            Your SSL certificate is pending validation. Please add the following
      ...
      <div className="space-y-4">
        <h3 className="text-lg font-semibold">
          Step 1: Certificate Validation Records
        </h3>
        <p className="text-sm text-muted-foreground">
          Add these CNAME records to validate your domain ownership with AWS
          Certificate Manager:
        </p>
          ...
          <div key={index} className="bg-secondary p-4 rounded-lg space-y-2">
            <div className="flex justify-between items-start">
              ...
              <Button
                ...
                variant="outline"
                onClick={() =>
                  copyToClipboard(`${record.Name} -> ${record.Value}`)
                }
              >
      ...
      <div className="space-y-4">
        <h3 className="text-lg font-semibold">
          Step 2: Point Your Domain to Load Balancer
        </h3>
        <p className="text-sm text-muted-foreground">
          After validation, add this CNAME record to point your domain to the
          AWS load balancer:
        </p>
      ...
      <Alert>
        <AlertDescription>
          ...
          Certificate validation typically completes within 15 minutes after DNS
          records are added.
        </AlertDescription>
      </Alert>
    </div>
